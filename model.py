...
class vdsr(nn.Module):
    def __init__(self):
        ...
        self.residual_layer = self.make_layer(Conv_ReLU_Block, 2)
...
class vdsr_dem(nn.Module):
    def __init__(self):
        ...
        rgb_std_dem = [1.0]
        self.sub_mean_dem = MeanShift(1228.3303, rgb_mean_dem, rgb_std_dem,1)  
    ...
    def forward(self, x,zg,t):
        residual = x
        x_1=torch.cat((x,zg,t),dim=1)
